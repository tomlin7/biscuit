...
KINDS = [("D", "Deleted", "Red"), ("A", "Added", "Green"), ("M", "Modified", "Yellow")]
...
class TreeItem(Frame):
    ...
    def __init__(self, master, path, kind, *args, **kwargs):
        ...
        Label(self, text=KINDS[self.kind][0], fg=KINDS[self.kind][2], font=("Segoe UI", 10), padx=5, pady=2, **self.base.theme.views.sidebar.item.content).pack(fill=tk.BOTH)
