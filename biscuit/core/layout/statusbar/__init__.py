...
class Statusbar(Frame):
    ...
    def __init__(self, master, *args, **kwargs):
        ...
        self.lc_actionset = ActionSet(
            "GOTO", ":", permitems=[["goto line: {}", lambda line=None: self.base.editorsmanager.active_editor.content.goto(int(line)) if line and line.isnumeric() else print("failed goto line", line)]]
        )
