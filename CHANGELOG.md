...
<small>[Compare with latest](https://github.com/tomlin7/biscuit/compare/v2.58.0...HEAD)</small>
...
<!-- insertion marker -->
## [v2.58.0](https://github.com/tomlin7/biscuit/releases/tag/v2.58.0) - 2024-01-12
...
## [v2.33.0](https://github.com/tomlin7/biscuit/releases/tag/v2.33.0) - 2023-11-15
...
## [v2.31.0](https://github.com/tomlin7/biscuit/releases/tag/v2.31.0) - 2023-10-22
...
- fix: Update cupcake core - merge cupcake updates - consider https://github.com/tomlin7/cupcake/pull/37 ([beff32b](https://github.com/tomlin7/biscuit/commit/beff32b1458c85284c48a869e64cca11494a7ad0) by Billy).
...
## [v2.5.2](https://github.com/tomlin7/biscuit/releases/tag/v2.5.2) - 2023-07-11

<small>[Compare with v2.5.1](https://github.com/tomlin7/biscuit/compare/v2.5.1...v2.5.2)</small>

## [v2.5.1](https://github.com/tomlin7/biscuit/releases/tag/v2.5.1) - 2023-07-10
...
## [2.0.0](https://github.com/tomlin7/biscuit/releases/tag/2.0.0) - 2023-06-14
...
- Add sysinfo to base class ([dbe909d](https://github.com/tomlin7/biscuit/commit/dbe909dd1857de715f6a90e8d2e881436efbed53) by tomlin7).
- Add new terminal ([ea2189f](https://github.com/tomlin7/biscuit/commit/ea2189fb3d9176a4d5fe4589ce90a2f05ca45157) by tomlin7).
- add start buttons and useful resources to welcome page ([5468e23](https://github.com/tomlin7/biscuit/commit/5468e23bfe2368ea494c58831401a66d13f399f7) by tomlin7).
- Add welcome page ([0f82887](https://github.com/tomlin7/biscuit/commit/0f8288754607e9f55e1b571f2d2a262cd2daa442) by tomlin7).
- Add diff colors based on changes ([3fb016e](https://github.com/tomlin7/biscuit/commit/3fb016e8c265e90f88d188ba5ef318efce38d639) by tomlin7).
- Add filetype library to dependencies, new filetype class ([7d195bc](https://github.com/tomlin7/biscuit/commit/7d195bcb0666b30c8475a5c9ed0ced5de2839bea) by tomlin7).
- Add toolbar containing dirname, refresh, newfile elements ([c7670b4](https://github.com/tomlin7/biscuit/commit/c7670b45f7e968cc4971fcb0b4a8f630591a9eec) by tomlin7).
...
- Add README for repository ([6d46770](https://github.com/tomlin7/biscuit/commit/6d46770ae86e520b53771d7df331bab0f14aa323) by tomlin7).
- Add Contributing guidelines ([321b06f](https://github.com/tomlin7/biscuit/commit/321b06f1254c710cfc036b144ee1ca2cecc3f53a) by tomlin7).
- Add CODE OF CONDUCT ([f9d09e6](https://github.com/tomlin7/biscuit/commit/f9d09e6e6441e3d3ea341f0a650ad0fb07ad784e) by tomlin7).
- Add sample colorizer ([237904b](https://github.com/tomlin7/biscuit/commit/237904bd36a8a0f3721f9ec6e823452ce038270c) by tomlin7).
- Add shortcuts to emptytab ([a2cffd9](https://github.com/tomlin7/biscuit/commit/a2cffd93fd446ac8eb0186a3ad80b6d00f2291f0) by tomlin7).
- Add Resources Holder, Loader ([7fb0afd](https://github.com/tomlin7/biscuit/commit/7fb0afda29625ce9166468165ec296213ba2588f) by tomlin7).
- Add items that contain the term ([543f76f](https://github.com/tomlin7/biscuit/commit/543f76f0e169ecd01818d7503c6cf425578763c7) by tomlin7).
- add_all_items method, default size should be 70 ([f1992d9](https://github.com/tomlin7/biscuit/commit/f1992d9c929fb6660e5ad82ef86e5d9257af8607) by tomlin7).
- add git to requirements ([a004f14](https://github.com/tomlin7/biscuit/commit/a004f14563f5e2dbfbd3a7f784294eda654bebbb) by tomlin7).
- Add statusbar to the application ([4fcaa7e](https://github.com/tomlin7/biscuit/commit/4fcaa7ee891736fe07ca6aa147892e987477e66e) by tomlin7).
- Add `python-tkdnd` to requirements ([0cfaa5b](https://github.com/tomlin7/biscuit/commit/0cfaa5b963bf4fe36cbda427de943b509cd9f0f3) by tomlin7).
- Add requirements.txt ([b8dfdfa](https://github.com/tomlin7/biscuit/commit/b8dfdfadd1d5de217c0e493b2dcca6f954b7aca7) by tomlin7).
- Add pytest to project ([8eed5a2](https://github.com/tomlin7/biscuit/commit/8eed5a23937931c90006eb0dfc6b05d61a0461ee) by tomlin7).
- Add tkterminal submodule ([4ae5821](https://github.com/tomlin7/biscuit/commit/4ae5821b80eeef4a26fd8453262a2756a76d4ee7) by tomlin7).
- Add default settings, basic bindings, default theme ([c1fd236](https://github.com/tomlin7/biscuit/commit/c1fd236060a6207ca32bcbc4611ca94483dbf36a) by tomlin7).
- Add config files ([88c8dbb](https://github.com/tomlin7/biscuit/commit/88c8dbb21ecad87624526c8dc6c24dc362246ab2) by tomlin7).
- Add run API method for root ([e0551de](https://github.com/tomlin7/biscuit/commit/e0551de5aacfe0f65155e85ba01b72026e6d13e2) by tomlin7).
- Add gitignore ([57d855f](https://github.com/tomlin7/biscuit/commit/57d855f5a4d7318e3cbce393f7438d282a32bdf1) by tomlin7).
...
- Fix command palette sizing, Update preview ([b57e4c5](https://github.com/tomlin7/biscuit/commit/b57e4c5aee6013812887f7088e2718da80380ac7) by tomlin7).
- Fix sizes ([06f18ef](https://github.com/tomlin7/biscuit/commit/06f18ef5b1e9900a53dd034db672f016451b2a74) by tomlin7).
- Fix bug in diff, decoding content properly ([5a2e6d3](https://github.com/tomlin7/biscuit/commit/5a2e6d3444bc6bc99f1ff5de6cfbbbfca252f5da) by tomlin7).
- Fix zooming of editor affects editor pane size ([a2c9c76](https://github.com/tomlin7/biscuit/commit/a2c9c765f8cb4d8a6b55aeedb27a9912f505c15b) by tomlin7).
- fix show_unsupported_dialog ([fb71e08](https://github.com/tomlin7/biscuit/commit/fb71e08020bf7cc0830ce967d7998f09dcc29f56) by tomlin7).
- Fix bindings ([b541956](https://github.com/tomlin7/biscuit/commit/b54195635ac174b66e47a2ef5091af2dcff68b53) by tomlin7).
- fix in theme settings ([af69d7b](https://github.com/tomlin7/biscuit/commit/af69d7b74528f6ce2e78bac680863572ca3c0bd2) by tomlin7).
- fix in theme loader, default value for theme parameter ([0eb2806](https://github.com/tomlin7/biscuit/commit/0eb2806e2e1b6d330f33a5a6b832918abb5e6509) by tomlin7).
- fix bug in bindings loader ([648e0da](https://github.com/tomlin7/biscuit/commit/648e0da0d79271516008e67e2405852b5d16f86d) by tomlin7).

### Changed

- Change line numbers background ([0bcc352](https://github.com/tomlin7/biscuit/commit/0bcc3527ff910644af7ff1d5ae89273c707858f5) by tomlin7).
- Change sidepane width on enabling ([8f578a9](https://github.com/tomlin7/biscuit/commit/8f578a936c2a5f4404632d7ba9209d6a5f567094) by tomlin7).
- Change GitWindow to GitPane ([c8a6d96](https://github.com/tomlin7/biscuit/commit/c8a6d96083edf55a54500eac9a6be64be698ef62) by tomlin7).
- change binding of command pallette to ctrl-shift-p ([02b316f](https://github.com/tomlin7/biscuit/commit/02b316f5790e4181fdd1c00582b5830fd32480f8) by tomlin7).
- Change font of editorpath ([7abc775](https://github.com/tomlin7/biscuit/commit/7abc775ed5bfe032bfbf2aa51b13779ea31fc21f) by tomlin7).
- changes in tkterminal ([8151a2c](https://github.com/tomlin7/biscuit/commit/8151a2c1a1e4245da01e147b0881ee7d7961ef75) by tomlin7).
...
- Remove unused dnd class ([bdf6be6](https://github.com/tomlin7/biscuit/commit/bdf6be66a5de9a2bff4fe73da0f189d05f606672) by tomlin7).
- Removed tkterminal ([18d8e64](https://github.com/tomlin7/biscuit/commit/18d8e64b8ac4cba7799c7c2ee12d642050f5f381) by tomlin7).
- Remove find replace widget ([20add20](https://github.com/tomlin7/biscuit/commit/20add20414c0ac210dc61242a30cd226ec2abd26) by tomlin7).
- Remove test.py ([5e67841](https://github.com/tomlin7/biscuit/commit/5e678410d826f249a8fe2b72e589ae3797ed8728) by tomlin7).
...
- Remove unnecessary details from git toolbar ([5638f41](https://github.com/tomlin7/biscuit/commit/5638f41f22962aa1f56b08ff1472496a992b66bd) by tomlin7).
- Remove tree headings ([5705dae](https://github.com/tomlin7/biscuit/commit/5705dae563e62024dcb39e13c1e544a986e3155a) by tomlin7).
- Remove obsolete left container ([a9a645e](https://github.com/tomlin7/biscuit/commit/a9a645e6b47012fa7769d867100b4a45b8752a8e) by tomlin7).
- Remove sidebar test application ([c507753](https://github.com/tomlin7/biscuit/commit/c507753a5d340671650738da3ad35a11b629a647) by tomlin7).
- Remove test editor components ([81a05e2](https://github.com/tomlin7/biscuit/commit/81a05e2f0e94455f045e91c489909825d4592485) by tomlin7).
- Remove editor bindings for now ([9a088a0](https://github.com/tomlin7/biscuit/commit/9a088a0b87b33e95003b0d3dec17ee7c79021f21) by tomlin7).
- remove statusbar for now ([89667e2](https://github.com/tomlin7/biscuit/commit/89667e2e8090696fa52891b128abe4cc0489bf53) by tomlin7).
- remove cache dirs and files ([d95110c](https://github.com/tomlin7/biscuit/commit/d95110c0f4a2f4b5a3b499b07a9a4567dac3801e) by tomlin7).