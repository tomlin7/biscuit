...
if typing.TYPE_CHECKING:
    ...
    from src.biscuit.components import Editor

import os
import tkinter as tk

from src.biscuit.utils import Frame, Icon, IconButton
...
class Tab(Frame):
    def __init__(self, master: Tabs, editor: Editor, *args, **kwargs) -> None:
        ...
        self.icon = Icon(self, 'file', **self.base.theme.layout.base.content.editors.bar.tab.icon)
