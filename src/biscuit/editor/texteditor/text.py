...
if typing.TYPE_CHECKING:
    from src.biscuit.components.lsp.data import WorkspaceEdits, HoverResponse, Jump, Underlines, Completions
    from . import TextEditor

from src.biscuit.utils import Text as BaseText
from src.biscuit.utils import textutils
