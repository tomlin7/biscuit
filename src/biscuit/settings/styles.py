...
class Style(ttk.Style):
    ...
    def config_treeview(self) -> None:
        ...
        self.img_tree_close = tk.PhotoImage(
            "img_tree_close",
            data="""
        ...
        self.img_tree_open = tk.PhotoImage(
            "img_tree_open",
            data="""
                iVBORw0KGgoAAAANSUhEUgAAAAsAAAALCAYAAACprHcmAAAACXBIWXMAAA7DAAAOwwHHb6hkAAAAGXRFWHRTb2Z0d
        ...
        self.img_tree_empty = tk.PhotoImage(
            "img_tree_empty",
            data="""
                iVBORw0KGgoAAAANSUhEUgAAAAsAAAALCAYAAACprHcmAAAACXBIWXMAAA7DAAAOwwHHb6hkAAAAGXRFWHRTb2Z0d
        ...
        self.map(
            "Treeview",
            background=[("selected", self.theme.utils.tree.item.selectedbackground)],
        )
            ...
            [
                (
                    "Treeitem.padding",
                    {
                        "sticky": "nswe",
                        "children": [
                            ("Treeitem.nindicator", {"side": "left", "sticky": ""}),
