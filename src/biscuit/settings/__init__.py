...
from src.biscuit.common import get_games
from src.biscuit.utils.classdrill import extract_commands, formalize_command
...
class Settings:
    ...
    def gen_actionset(self) -> None:
        ...
        from src.biscuit.components import ActionSet
