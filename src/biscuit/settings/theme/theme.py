...
class ThemeObject(Mapping):
    ...
    def __init__(
        ...
        selectedbackground: str = None,
        selectedforeground: str = None,
        **kwargs,
    ) -> None:
        self.master = master
        ...
        self.selectedbackground = (
            selectedbackground or highlightbackground or master.selectedbackground
        )
        self.selectedforeground = (
            selectedforeground or highlightforeground or master.selectedforeground
        )
...
class Layout(FrameThemeObject):
    def __init__(self, theme, *args, **kwargs) -> None:
        ...
        self.statusbar.button_highlighted = HighlightableThemeObject(
            self.statusbar,
            self.master.biscuit,
            "white",
            self.master.biscuit_dark,
            "white",
        )
...
class Editors(FrameThemeObject):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.linenumbers.breakpoint = HighlightableThemeObject(
            self.linenumbers, "#f5a199", "white", "#e51400", "white"
        )
...
class Theme:
    ...
    String = "#b11515"
    Number = "#098658"
    Comment = {"foreground": "#098658", "font": {"slant": "italic"}}
    Punctuation = "#3b3b3b"
    ...
    def __init__(self) -> None:
        ...
        # Tree-sitter capture name -> color mapping
        self.treesitter_syntax = {
            "keyword": self.Keyword,
            "keyword.function": self.Keyword,
            "keyword.return": self.Keyword,
            "keyword.operator": self.Keyword,
            "keyword.import": self.Keyword,
            "keyword.type": self.Keyword,
            "keyword.conditional": self.Keyword,
            "keyword.repeat": self.Keyword,
            "keyword.exception": self.Keyword,
            "keyword.directive": self.Keyword,
            ...
            "type": self.Name,
            "type.builtin": self.Name,
            "type.definition": self.Name,
            "type.qualifier": self.Keyword,
            "variable": self.Name,
            "variable.builtin": self.Name,
            "variable.parameter": self.Name,
            "variable.member": self.Name,
            "property": self.Name,
            "attribute": self.Name,
            "attribute.builtin": self.Name,
            "constant": self.Name,
            "constant.builtin": self.Name,
            "string": self.String,
            "string.special": self.String,
            "string.escape": self.String,
            "string.regexp": self.String,
            "string.documentation": self.String,
            "number": self.Number,
            "number.float": self.Number,
            "boolean": self.Keyword,
            "float": self.Number,
            ...
            "operator": self.Punctuation,
            "tag": self.Name,
            "tag.attribute": self.Name,
            "tag.delimiter": self.Punctuation,
            "namespace": self.Name,
            "module": self.Name,
            "label": self.Name,
            "decorator": self.Name,
