...
class FindBox(EntryBox):
    def __init__(self, master, *args, **kwargs):
        ...
        self.full_word = Button(self.btn_frame, bg="#ffffff", hbg="#e9e9e9", img=tk.PhotoImage(data="""
        ...
        self.regex_button = Button(self.btn_frame, bg="#ffffff", hbg="#e9e9e9", img=tk.PhotoImage(data="""
